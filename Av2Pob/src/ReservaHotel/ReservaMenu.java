...
public class ReservaMenu {
    ...
    public static void incluirReserva() {
        System.out.println("INSERIR DADOS DA RESERVA");
    ...
    public static void alterarReserva() {
        ...
        System.out.println("ALTERAR DADOS DA RESERVA");
        ...
        System.out.println("Dados da reserva alterados com sucesso!");
    }
    ...
    public static void excluirReserva() {
        ...
        System.out.println("Tem certezade que deseja excluir a reserva? (S/N)");
        String confirmacao = scanner.nextLine();

        if (confirmacao.equalsIgnoreCase("S")) {
            // Remover a reserva do arquivo ou banco de dados
